...
var (
	pattern_AuthService_SignIn_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"auth", "signin"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_AuthService_SignOut_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"auth", "signout"}, "", runtime.AssumeColonVerbOpt(true)))
)
